...
from .montages import define_equipment, define_neighbor

from .rois import define_rois

_ant_montages = {"32": "standard_1020", "63": "standard_1020", "124": "standard_1020"}
...
_ant_63_rois = {
    ...
    "p3b": np.array(
        [9, 10, 14, 15, 16, 20, 21, 24, 25, 26, 28, 41, 44, 45, 50, 51, 54, 55]
    ),  # surrounding Cz Cz+Pz
    ...
    "scalp": np.concatenate(
        [np.arange(0, 12), np.arange(13, 18), np.arange(19, 31), np.arange(32, 64)]
    ),
...
_ant_124_rois = {
    ...
    "Cz": np.array([9, 10, 14, 15, 16, 20, 21, 41, 44, 45]),
    "Pz": np.array([20, 21, 24, 25, 26, 28, 50, 51, 54, 55]),
    "scalp": np.concatenate([np.arange(0, 12), np.arange(13, 18), np.arange(19, 124)]),
