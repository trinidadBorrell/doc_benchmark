...
_stats_functions = {
    ...
    "std": {"description": "Standard Deviation", "func": np.std},
    "mean": {"description": "Mean", "func": np.mean},
}
...
def next_reduction_module(
    module_name: str, estimators: List[str], module_description: str = ""
):
