...
::
    ...
    python plot_layerwise_r2.py --output-dir /path/to/LINEAR_PROBING
    python plot_layerwise_r2.py --output-dir /path/to/LINEAR_PROBING --models CbraMod
    python plot_layerwise_r2.py \\
...
# Classification constants (mirrors plot_layerwise_crs_auc.py)
